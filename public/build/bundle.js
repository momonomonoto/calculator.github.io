...
/***/ function(module, exports, __webpack_require__) {
	...
	var _userShopJsx = __webpack_require__(159);

	var _userShopJsx2 = _interopRequireDefault(_userShopJsx);

	var _userInboxPageJsx = __webpack_require__(160);

	var _userInboxPageJsx2 = _interopRequireDefault(_userInboxPageJsx);

	// Render the ServiceChooser component, and pass the array of services

	_reactDom2['default'].render(_react2['default'].createElement(_userShopJsx2['default'], null), document.getElementById('mount-point'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("C:\\Users\\Brilliant\\Desktop\\Тестовый React\\reacttest\\node_modules\\react-hot-api\\modules\\index.js"), RootInstanceProvider = require("C:\\Users\\Brilliant\\Desktop\\Тестовый React\\reacttest\\node_modules\\react-hot-loader\\RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var Shop = _react2['default'].createClass({
	    ...
	    render: function render() {
	        ...
	        var avto = [{ name: 'Газель', price: 1300 }, { name: 'Форд', price: 1400 }, { name: 'Мерседес', price: 1250 }];

	        var items = [{ name: 'sss', price: 300 }, { name: 'Форд', price: 400 }, { name: 'Мерседес', price: 250 }];

	        var self = this;

	        var services = items.map(function (s) {
	            ...
	            return _react2['default'].createElement(Vov, { name: s.name, price: s.price, active: s.active, addTotal: self.addTotal });
	        });

	        var avtoSale = avto.map(function (s) {

	            // Create a new Service component for each item in the items array.
	            // Notice that I pass the self.addTotal function to the component.

	            return _react2['default'].createElement(Service, { name: s.name, price: s.price, active: s.active, addTotal: self.addTotal });
	        });
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(Bad, null)
	        );
	    }
	});
	...
	var Vov = _react2['default'].createClass({
	    displayName: 'Vov',
	...
	var Bad = _react2['default'].createClass({
	    displayName: 'Bad',
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\Users\\Brilliant\\Desktop\\Тестовый React\\reacttest\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Shop.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	...
	var InboxPage = _react2['default'].createClass({
		...
		render: function render() {
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					'div',
					{ className: 'Calculator__engine' },
					_react2['default'].createElement(
						'h2',
						null,
						' Предпочитаемый двигатель'
					),
					_react2['default'].createElement(
						'p',
						null,
						'Выбор двигателья ГАЗели исходит из следующего критерия вес перевозимого груза.'
					),
					_react2['default'].createElement(
						'p',
						null,
						'Если вес не превышает две тонны, то отлично подойдет 1JZ-GE.'
					),
					_react2['default'].createElement(
						'p',
						null,
						'Для веса до 3 тонн необходим более мощный двигатель -2JZGE'
					),
					_react2['default'].createElement(
						'p',
						null,
						'Двигатель 1USZ-FC и 5VZ-FC подойдут для ГАЗели при весе перевозимого груза до 5 тонн.'
					),
					_react2['default'].createElement(
						'ul',
						null,
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							...
							_react2['default'].createElement(
								'p',
								null,
								'Установка приборной панели от Toyota'
							),
							' ',
							_react2['default'].createElement(
								'p',
						...
						_react2['default'].createElement(
							...
							_react2['default'].createElement(
								'p',
								null,
								'Установка вибро и шумоизоляции'
							),
							_react2['default'].createElement(
								'p',
								null,
						...
						_react2['default'].createElement(
							...
							_react2['default'].createElement(
								'p',
								null,
								'Изготовление специального шпака высокого давления.'
							),
							_react2['default'].createElement(
								'p',
								null,
				...
				_react2['default'].createElement('div', { className: 'Calculator__moreOption' }),
				_react2['default'].createElement(
					'div',
